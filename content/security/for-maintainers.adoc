...
. A *date and time of the release is coordinated* between the security team and maintainers.
  The security team handles CVE ID assignment (in cases where there is no CNA conflict), advance notification of users, and creation of the security advisory.
